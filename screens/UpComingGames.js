            ...
            <View style={{flexDirection: 'row',gap: 10,backgroundColor: 'white',marginTop: 12}}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{marginVertical: 10,padding: item?.isBooked ? 0 : 15,borderRadius: 8,borderColor: '#E0E0E0',borderWidth: 1,width: '100%'}}>
                    {
                        item?.isBooked ? (
                        <>
                            <Text style={{textAlign: 'center',fontWeight: '500',fontSize: 13,paddingVertical: 10}}>
                                {item?.courtNumber}
                            </Text>

                            <View style={{justifyContent: 'center',alignItems: 'center',backgroundColor: '#56cc79',paddingVertical: 5}}>
