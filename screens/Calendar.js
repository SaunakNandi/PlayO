...
const Calendar = ({onSelectedDate,selected,selectedSport,onSelectedTime}) => {
                ...
                onScroll={(e)=>setScrollPosition(e.nativeEvent.contentOffset.x)}>
                    {
                        dates?.map((date)=>{
                            return(
                                <Dates key={date} setSelectedTime={onSelectedTime} onSelectedDate={onSelectedDate}
                                date={date} selected={selected}/>
                            )
                        })
                    }
                </ScrollView>
